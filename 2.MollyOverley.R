...
pdf('MO_genomewide.pdf', height = 6.5, width = 11)
...
chrX_bwa=allchr_bwa[allchr_bwa$CHR==18,] #6D = 18

pdf('MO_6DS.pdf', height = 6.5, width = 11)
manhattan(chrX_bwa, suggestiveline = F, genomewideline = -log10(alpha/nrow(allchr_bwa)), cex.lab=1.4)

abline(v=214085311, col='gray', lwd=7) #6D - Molly and Joy
text(x = 214085400, y = 9, labels = 'Centromere', srt=90, pos=4, offset = 0.7, cex = 1)
text(x = 220086000, y = 7.5, labels = 'Bonferroni threshold', pos=4, offset = 0.7, cex = 1)
...
# 6D of molly x newton
molly_6d.overley = chrX_bwa

genome.molly.overley = allchr_bwa
#####################